...
public class PayStatusView extends View {
    ...
    public PayStatusView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PayStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.PayStatusView, defStyleAttr, 0);
        progressColor = array.getColor(R.styleable.PayStatusView_progress_color, ContextCompat.getColor(context, R.color.colorPrimary));
        loadSuccessColor = array.getColor(R.styleable.PayStatusView_load_success_color, ContextCompat.getColor(context, R.color.load_success));
        loadFailureColor = array.getColor(R.styleable.PayStatusView_load_failure_color, ContextCompat.getColor(context, R.color.load_failure));
        progressWidth = array.getDimension(R.styleable.PayStatusView_progress_width, 6);
        progressRadius = array.getDimension(R.styleable.PayStatusView_progress_radius, 100);
        array.recycle();
